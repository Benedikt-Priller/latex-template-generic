...
% Footer
\newtranslation[to=spanish]{Page}{Página}
\newtranslation[to=ngerman]{Page}{Seite}
\newtranslation[to=english]{Page}{Page}
\newtranslation[to=spanish]{Version}{Versión}
\newtranslation[to=ngerman]{Version}{Version}
\newtranslation[to=english]{Version}{Version}
\ifoot{\translate{Version}: \aktuelleVersion}
\ofoot[\translate{Page} \thepage/\pageref*{LastPage}]{\translate{Page} \thepage\ / \pageref*{LastPage}}
