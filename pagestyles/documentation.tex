...
% Standard pagestyle with arabic numbering
% Header and footer -----------------------------------------------------------
...
\ifoot{\makecell[l]{\GetTranslation{version}: \aktuelleVersion}}
\ofoot[\GetTranslation{page} \thepage/\pageref*{LastPage}]{\makecell[r]{\GetTranslation{page} \thepage\ / \pageref*{LastPage}}}
\setlength{\footskip}{18pt}

% Custom pagestyle for frontmatter with roman numbering
\newpairofpagestyles{frontmatterstyle}{
  \clearpairofpagestyles
  \lohead{\makecell[tl]{\large{\textsc{\titel}}\\ \small{\kurzerUntertitel} \\[0.0ex] \textit{\headmark}}}
  \rohead{\makecell[tr]{\today \\ \autorName \\ \class}}
