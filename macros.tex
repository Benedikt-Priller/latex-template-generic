...
% Custom paths
%==========================================================
\newcommand{\drawingspath}[1]{\def\@drawingspath{#1}}
% \newcommand{\svgpath}[1]{\def\@svgpath{#1}}
\newcommand{\pngpath}[1]{\def\@pngpath{#1}}
\drawingspath{{./drawio/}}
% \svgpath{{./graphics/}}
\pngpath{{./graphics/}}
...
%   \oldsqrt[\leftroot{0}\uproot{2}#1]{#2}%
% }
...
% Fix spacing for equations and align env
